...
export default function SignIn() {
    ...
    return (
        <section>
            ...
            <div div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto">
                ...
                <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
                    <form onSubmit={onSubmit}>
                        ...
                        <div className="flex justify-between whitespace-nowrap text-sm sm:text-lg">
                            <p className="mb-6">
                                Não tem uma conta?
                                <Link to="/sign-up" className="text-red-600 hover:text-red-700 transition duration-200 ease-in-out ml-1">Registrar</Link>
                            </p>
                            <p>
